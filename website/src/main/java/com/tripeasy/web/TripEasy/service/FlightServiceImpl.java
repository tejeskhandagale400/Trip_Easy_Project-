...
public class FlightServiceImpl implements FlightService {
	...
	public Booking bookFlight(Booking booking) {
		return restTemplate.postForObject("http://localhost:7878/bookings/type/?bookingType=flight", booking, Booking.class);
	}


	@Override
	public ResponseEntity<Flight> getFlight(Integer flightId) {
		String url="http://localhost:7070/flight/"+flightId;
	...
	public ResponseEntity<Flight> updateSelectedSeats(Integer flightId,Flight flight) {
		String url="http://localhost:7070/flight";
	...
	public Boolean withdrawMoneyFromUserWallet(Integer profileId, Double totalPrice) {
		String url="http://localhost:8080/wallet/payMoney?senderProfileId="+profileId+
